      ...
      <Container size="md" style={{ position: 'relative', zIndex: 1 }}>
        <div ref={ref}>
          <Text
            ...
            style={{ letterSpacing: '3px', color: 'rgba(255,255,255,0.9)', textTransform: 'uppercase', marginBottom: 16, display: 'block' }}
          >
            ¿LISTO PARA EMPEZAR?
          </Text>
          ...
          <Title
            order={2}
            fz={{ base: '1.75rem', sm: '2.25rem', md: '2.75rem' }}
            mb="md"
            lh={1.2}
            className={`reveal ${isVisible ? 'visible' : ''}`}
          ...
          <Text
            ...
            mx="auto"
            className={`reveal ${isVisible ? 'visible' : ''}`}
            style={{ color: 'rgba(255,255,255,0.92)', transitionDelay: '0.24s' }}
          >
